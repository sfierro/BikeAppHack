 ...
 */
public class BldgSevenFive extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn = (Button) findViewById(R.id.twotext);
